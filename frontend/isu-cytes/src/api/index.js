...
import * as ImgurAPI from './imgur.js'
...
export {
  POIAPI, PersonAPI, ReviewAPI, ListAPI, ImgurAPI, RecaptchaAPI,
  BASE_URL, WEBSOCKET_URL, RatePointWebSocket, RECAPTCHA_WEBTASK_SERVER_URL,
  IMGUR_URL
}
